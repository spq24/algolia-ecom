			...
			<>
				...
				<div className="page-content bg-white">
					<div className="page-banner ovpr-dark overlay-dotted ovdt2 parallax" style={{backgroundImage: "url("+bannerPic1+")"}}>
						<div className="container">
							<div className="page-banner-entry">
								<h1 className="text-white">Portfolio Grid Wide</h1>
								<div className="breadcrumb-row">
									<ul className="list-inline">
										<li><Link to="/"><i className="fa fa-home"></i>Home</Link></li>
										<li>Portfolio Grid Wide</li>
									</ul>
								</div>
							 </div>
						</div>
					...
					<div className="content-block" id="content-area">
						...
						<div className="section-area section-sp3 bg-white" style={{backgroundImage: "url("+pattern1+")"}}>
