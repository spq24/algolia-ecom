...
// Elements
import Masonry from "../../elements/portfolio/masonry7";
...
class PortMasonryGrid4 extends Component{
	render(){
		return(
			...
			<>
				...
				<div className="page-content bg-white">
					...
					<div className="content-block" id="content-area">
						...
						<div className="section-area section-sp2 bg-gray" style={{backgroundImage: "url("+patternpt1+")"}}>
							<div className="container">
...
export default PortMasonryGrid4;