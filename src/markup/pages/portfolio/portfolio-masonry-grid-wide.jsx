...
// Elements
import Masonry from "../../elements/portfolio/masonry8";
...
class PortMasonryGridWide extends Component{
	render(){
		return(
			...
			<>
				...
				<div className="page-content bg-white">
					...
					<div className="content-block" id="content-area">
						...
						<div className="section-area section-sp3 bg-white" style={{backgroundImage: "url("+patternpt1+")"}}>
...
export default PortMasonryGridWide;